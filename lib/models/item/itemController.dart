...
import 'package:fashion/models/item/itemModel.dart';
import 'package:scoped_model/scoped_model.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';


mixin ItemController on Model{
  ...
  Future<bool> addItem(String itemName, double itemPrice, String itemDescription) async {
    ...
    http.Response _response = await http.post('https://newproject-aa1fd.firebaseio.com/item.json', body: json.encode(_newItem));
  ...
  Future<bool> getItems() async {
    ...
    http.Response _response = await http.get('https://newproject-aa1fd.firebaseio.com/item.json');
  ...
  Future<bool> deleteItem(String id) async {
    ...
    http.Response _response = await http.delete('https://newproject-aa1fd.firebaseio.com/item/$id.json');
